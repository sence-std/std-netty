/**
 * @FileName:RpcInvocationHanlder
 * @Package: com.std.netty.rpc
 *
 * @author sence
 * @created 4/15/2015 1:01 PM
 *
...
public class RpcInvocationHanlder implements InvocationHandler{
	...
	private NettyClientRpcHandler rpcHandler;

	public RpcInvocationHanlder (NettyClientRpcHandler rpcHandler) {
	...
	public Object invoke (Object proxy, Method method, Object[] args) throws Throwable {
		CustomInvocation invocation = new CustomInvocation();
